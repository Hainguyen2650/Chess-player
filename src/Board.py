...
class GUI_Board:
    ...
    def handle_click(self, mx, my):
        ...
        try:
            move_made = self.selected_piece.move(clicked_square, get_pos=True)
...
class Piece(chess.Piece):
    ...
    def move(self, square:Square, force=False, get_pos=False):
        ...
        if square in self.get_valid_moves() or force:           
            ...
            return move_cur + move_new if get_pos==False else (cur_pos, new_pos)
